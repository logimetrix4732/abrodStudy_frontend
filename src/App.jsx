  ...
  return (
    <>
      ...
      <main className="main_wrapper overflow-hidden">
        ...
        <header>
          <div className="headerarea transparent__header header__sticky header__area">
                      ...
                      <ul>
                                ...
                                <div className="row">
                                  ...
                                  <div className="col-3 mega__menu__single__wrap">
                                    <div className="mega__menu__thumb">
                                      ...
                                      <span className="mega__menu__thumb__label">
                                        New
                                      </span>
                                    </div>
                                  </div>
                        ...
                        <li>
                          ...
                          <ul className="headerarea__submenu headerarea__submenu--third--wrap">
                            <li>
                              <a href="https://html.themewin.com/edurock-preview/admin-dashboard.html">
          ...
          <div className="container">
            <div className="row">
              <div
                ...
                data-aos="fade-up"
              >
                <div className="educationarea__wrapper">
                  <div className="educationarea__button">
                    <div className="default__small__button">Education</div>
                  </div>
                  <div className="educationarea__heading">
                    <h2>Cloud-based LMS Trusted by 1000+</h2>
                  </div>
                  <div className="educationarea__content">
                    <p>
                      Lorem Ipsum is simply dummy text of the printing
                      typesetting industry. Lorem Ipsum has been{" "}
                    </p>
                  </div>
                  <div className="educationarea__bottom__button">
              ...
              <div
                ...
                data-aos="fade-up"
              >
                <div className="educationarea__right__wraper" data-tilt="">
                  <div className="educationarea__img">
                    <img
                      loading="lazy"
                      className="education__img__1"
                      src="img/education/education.png"
                      alt="education"
                    />
                    <img
                      loading="lazy"
                      className="education__img__2"
                      src="img/education/education__1.png"
                      alt="education"
                    />
                    <img
                      loading="lazy"
                      className="education__img__3"
                      src="img/education/education__2.png"
                      alt="education"
                    />
                    <img
                      loading="lazy"
                      className="education__img__4"
                      src="img/education/education__3.png"
                      alt="education"
                    />
                  </div>
                  <div className="educationarea__small__img">
                    <a href="#">
                      <img
                        loading="lazy"
                        className="education__img__5"
                        src="img/education/education__4.png"
                        alt="education"
                      />
                      <img
                        loading="lazy"
                        className="education__img__6"
                        src="img/education/education__5.png"
                        alt="education"
                      />
                      <img
                        loading="lazy"
                        className="education__img__7"
                        src="img/education/education__6.png"
                        alt="education"
                      />
                      <img
                        loading="lazy"
                        className="education__img__8"
                        src="img/education/education__7.png"
                        alt="education"
                      />
                    </a>
                    <div className="educationarea__small__para">
                      <p>
                        Join over <span>4000+</span> students
                      </p>
                    </div>
                  </div>
                  <div className="educationarea__small__img__2">
                    <img
                      loading="lazy"
                      src="img/about/about_16.png"
                      alt="educator"
                    />
                    <div className="educationarea__small__content">
            ...
            <div className="educationarea__shape_image">
              <img
                loading="lazy"
        ...
        <div className="trainingarea sp_bottom_20" data-aos="fade-up">
          <div className="container">
            <div className="row">
              <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                <div className="trainingarea__wraper">
                  <div className="trainingarea__icon">
              ...
              <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                <div className="trainingarea__wraper trainingarea__wraper__2">
                  <div className="trainingarea__icon">
                    <i className="icofont-business-man-alt-1" />
                    <div className="trainingarea__content">
                      <h6>
                        <a href="#">Expert Teaceher</a>
                      </h6>
                      <p>With unlimited courses</p>
                    </div>
                  </div>
              ...
              <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                <div className="trainingarea__wraper trainingarea__wraper__3">
                  <div className="trainingarea__icon">
                    <i className="icofont-book-alt" />
                    <div className="trainingarea__content">
                      <h6>
                        <a href="#">Versatile Course</a>
                      </h6>
                      <p>With unlimited courses</p>
                    </div>
                  </div>
        ...
        <div className="aboutarea sp_top_30" data-aos="fade-up">
          <div className="container">
            <div className="row">
              ...
              <div className="col-xl-6 col-lg-6 col-md-12 col-12 ">
                <div className="aboutarea__content__wraper">
                  ...
                  <div className="aboutarea__list">
                    <ul>
                      <li>
                        <i className="icofont-check" /> Explore a variety of
                        fresh educational teach
                      </li>
                      <li>
                        <i className="icofont-check" /> Explore a variety of
                        fresh educational teach
        ...
        <div className="populerarea sp_top_80 sp_bottom_50">
          <div className="container">
            <div className="row populerarea__wraper" data-aos="fade-up">
              ...
              >
                <div className="populerarea__button">
                  <a className="default__button" href="course.html">
                    All Catagories
                    <i className="icofont-long-arrow-right" />
                  </a>
                </div>
            ...
            <div className="row">
              ...
              >
                <div className="single__service">
                  ...
                  <div className="service__content">
                    <h3>
                      <a href="course-details.html">Programming Tech</a>
                    </h3>
              ...
              >
                <div className="single__service">
                  ...
                  <div className="service__content">
                    <h3>
                      <a href="course-details.html">Artist &amp; Design</a>
                    </h3>
                    <p>show creativity</p>
                  </div>
                  <div className="service__small__img">
              ...
              >
                <div className="single__service">
                  ...
                  <div className="service__content">
                    <h3>
                      <a href="course-details.html">Machine Learning</a>
                    </h3>
              ...
              >
                <div className="single__service">
                  ...
                  <div className="service__content">
                    <h3>
                      <a href="course-details.html">Marketing Analysis</a>
                    </h3>
                    <p>Science is power</p>
                  </div>
                  <div className="service__small__img">
        ...
        <div className="eventlistarea sp_top_50 sp_bottom_100">
          <div className="container">
            <div className="eventlistarea__bg">
              <svg
                width={938}
                height={919}
                viewBox="0 0 938 919"
            ...
            <div className="row eventarea__wraper" data-aos="fade-up">
              <div className="col-xl-7 col-lg-7 col-md-7">
                <div className="section__title eventarea__section__title">
                  <div className="section__title__button">
                    <div className="default__small__button">Event List</div>
                  </div>
                  <div className="section__title__heading heading__underline">
                    <h2>
                      We Arrange <span>learning</span> Event for student
                    </h2>
                  </div>
                </div>
              </div>
              <div className="col-xl-5 col-lg-5 col-md-5">
                <div className="eventarea__content">
                  <p>
                    Forging relationships between multi to national governments
                    and global NGOs begins.
                  </p>
            ...
            >
              ...
              >
                <div className="social__wrapper">
                  <div className="single__event__wraper" data-aos="fade-up">
                    <div className="eventarea__img">
                      <img
                        loading="lazy"
                        src="img/event/event__1.png"
                        alt="event"
                      />
                    </div>
                    <div className="eventarea__content__wraper">
                      <div className="eventarea__list">
                        <ul>
                          <li>
                            <i className="icofont-clock-time" /> 10.00Am - 11.00
                            am
                          </li>
                          <li>
                            <a href="instructor-details.html">Mirnsdo .H</a> -
                            Event Speaker
                          </li>
                        </ul>
                      </div>
                  ...
                  <div
                    className="single__event__wraper single__event__wraper__2"
                    data-aos="fade-up"
                  >
                    <div className="eventarea__content__wraper">
                      <div className="eventarea__list">
              ...
              <div
                ...
                id="projects__five"
                role="tabpanel"
                aria-labelledby="projects__five"
              >
                <div className="social__wrapper">
                  <div className="single__event__wraper" data-aos="fade-up">
                    <div className="eventarea__img">
                ...
                <div className="single__testimonial__wraper">
                  <div className="single__testimonial__inner">
                    <div className="testimonial__img">
                      <img
                        loading="lazy"
                        src="img/testimonial/testi_1.png"
                        alt="testi"
                      />
        ...
        <div className="footerarea">
          <div className="container">
            <div className="footerarea__newsletter__wraper">
              <div className="row">
                <div
                  ...
                  data-aos="fade-up"
                >
                  <div className="footerarea__logo">
                    <a href="#">
                      <img
                        loading="lazy"
            ...
            <div className="footerarea__wrapper">
              <div className="row">
                <div
                ...
                >
                  <div className="footerarea__inner footerarea__about__us">
                    ...
                    <div className="footerarea__content">
                      <p>
                        orporate clients and leisure travelers has been relying
                        on Groundlink for dependable safe, and professional
                        chauffeured car end service in major cities across
                        World.
                      </p>
                    </div>
            ...
            <div className="footerarea__copyright__wrapper">
              <div className="row">
                <div
                  className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12"
                  data-aos="fade-up"
                >
                  <div className="footerarea__copyright__content">
                    <p>
                      © 2024 Powered by <a href="#">Edurock</a>. All Rights
                      Reserved.
                    </p>
                  </div>
                </div>
                <div
                  ...
                  data-aos="fade-up"
                >
                  <div className="footerarea__copyright__list">
                    <ul>
                      <li>
