    ...
    <>
      ...
      <div className="mode_switcher my_switcher">
        <button
          ...
          className={`${isDarkMode ? "dark" : "light"} align-items-center`}
          onClick={toggleTheme}
        >
          <svg
            ...
            <div className="row">
              ...
              >
                <div className="service__animate__shape__1">
                  <img
                    loading="lazy"
                    src="img/service/service__shape__1.png"
                    alt=""
                  />
                </div>
              ...
              <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 service__wrap__content">
                <div className="service__animate__shape__2">
                  <img
                    loading="lazy"
                    src="img/service/service__shape__bg__1.png"
                    alt=""
                  />
                </div>
                <div className="row">
              ...
              >
                <div className="pricingarea__content__wraper">
                  ...
                  <div className="pricingarea__list">
                    <ul>
                      <li>
                        <i className="icofont-check" /> 2 user
                      </li>
                      <li>
                        <i className="icofont-check" /> Learning Scope
                      </li>
                      <li>
                        <i className="icofont-close close__button" /> Team
                        collaboration
                      </li>
                      <li>
                        <i className="icofont-check dark__color__2" /> Export
                        HTML code
                      </li>
                      <li>
                        <i className="icofont-check" /> Upload Your Logo
                      </li>
                    </ul>
                  </div>
              ...
              >
                <div className="pricingarea__content__wraper">
                  ...
                  <div className="pricingarea__list">
                    <ul>
                      <li>
                        <i className="icofont-check" /> 5 user
                      </li>
                      <li>
                        <i className="icofont-check" /> Learning Scope
                      </li>
                ...
                <div className="blogarea__content__wraper">
                  ...
                  <div className="blogarea__text__wraper">
                    ...
                    <div className="blogarea__para">
                      <p>
                        A wonderful serenity has taken possssion of my entire
                        souing like these sweet morning spring whch enjoy with
                        my whole heart I am alone, and feel the charm of
                        existenceths spot whch was create For the bliss of souls
                        like mineing am so happy my dear frend so absori bed in
                        the exquste sens of mere. A wonderful serenity has taken
                        posseson of my entire soung like these sweet mornngs
                        spring whch enjoy …
                      </p>
                    </div>
